        ...
        <div class="m-auto bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="m-5 border-b border-gray-200">
                ...
                <div class="p-2 m-2 flex justify-end">
                    ...
                    <!-- <Edicao :exameAux='form.exameAux' v-if="form.modalEditar"/> -->
                        ...
                        <div class="bg-gray-100 shadow mx-auto">
                                ...
                                <tbody class="bg-grey-light flex flex-col items-left justify-between overflow-y-scroll w-full" style="height: 20vh;">
                                    ...
                                    >
                                        ...
                                        <td class="text-right">
                                            ...
                                            <button class="ml-5 px-2 bg-blue-500 font-bold text-white rounded-md" @click.prevent="ativarGrupo(g.grupo, g.descricao)" v-if="exameAuxs ? !exameAuxs.includes(g.grupo) : false">Ativar</button> 
                                            <button class="ml-5 px-2 bg-red-500 font-bold text-white rounded-md" @click.prevent="desativarGrupo(g.grupo)" v-if="exameAuxs ? exameAuxs.includes(g.grupo) : false">Desativar</button> 
                                        </td>
                                    </tr>
                            ...
                            <tr v-for="(p, index) in procedimentos.data" :key="p.id"
                                ...
                                <td class="px-6 whitespace-nowrap">
                                    ...
                                    <div class="flex">
                                        <div class="flex-col">
                                            <span v-if="exameAuxs ? exameAuxs.includes(p.codigo.substring(0,5)) : false">
                                ...
                                <td class="px-2 py-2 text-md float-right">
                                    ...
                                    <EdicaoExameAux  :exameAux="{id: p.id, codigo: p.codigo, procedimento: p.procedimento,  disponivel: p.disponivel}" />
...
import CadastroExameAux from '../../Components/ExameAuxes/Cadastro.vue'
import EdicaoExameAux from '../../Components/ExameAuxes/Edicao.vue'
import ExcluirExameAux from '../../Components/ExameAuxes/Excluir.vue'
...
function statusToggle(disponivel, id){
    ...
    form.post(route('exameAuxes.store'), {
        only: ['procedimentos'],
...
function pesquisarExameAux(){
    form.searchClear = false
    form.get(route('exameAuxes.index'), {
        search: form.search
    })
}
...
function limparPesquisaExameAux(){
