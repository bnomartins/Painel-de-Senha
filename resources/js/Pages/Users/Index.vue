                    ...
                    <div class="mx-auto w-full whitespace-no-wrap">
                        ...
                        <div class="bg-gray-100 shadow mx-auto">
                            ...
                            <tr class="bg-neutral-200">
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-md text-gray-700 font-bold uppercase">Acesso</th>
                                <th scope="col" class="px-6 py-3 text-center text-md text-gray-700 font-bold uppercase">Email</th>
                            ...
                            <tr v-for="(u, index) in users.data" :key="u.id"
                                ...
                                <td class="px-2 py-2 text-md text-left">{{ u.name }}</td>
                                <td class="px-2 py-2 text-md text-left text-blue-600 font-bold">{{ u.access }}</td>
                                <td class="px-2 py-2 text-md text-left">{{ u.email }}</td>
                                <td class="px-2 py-2 text-md float-right">
                                    <EdicaoUser :user="u" :cbos="cbos"
                                    ...
                                    @click.prevent="excluirUser(u.id)"
                                    >
                                        Excluir
                                    </button> -->
                                </td>
...
import CadastroUser from '../../Components/Users/Cadastro.vue'
import EdicaoUser from '../../Components/Users/Edicao.vue'
import ExcluirUser from '../../Components/Users/Excluir.vue'
