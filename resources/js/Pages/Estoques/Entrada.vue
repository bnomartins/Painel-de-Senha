    ...
    <div class="m-auto overflow-hidden bg-white shadow-sm sm:rounded-lg">
      <div class="m-5 border-b border-gray-200">
        <form @submit.prevent="cadastrarEntrada()" class="w-full">
            ...
            <div class="container py-2 mx-auto min-w-min">
              ...
              >
                  ...
                  >
                    ...
                    <div class="w-1/6 mr-1">
                      <label
                        ...
                        >Fornecedor
                        <i
                          class="text-blue-500 fa fa-search"
                          aria-hidden="true"
                        ></i>
                      </label>
                      <input
                ...
                <div class="px-8">
                  ...
                  <div
                    class="w-full p-3 m-auto mt-5 mb-4 font-bold bg-gray-200 border shadow-md border-gray-50 text-md border-1 rounded-xl"
                  >
                    <div class="flex mb-4">
                      <div class="w-1/3 mr-1">
                        <label
                  ...
                  >
                    ...
                    <div class="flex mb-4">
                      ...
                      <div
                        class="w-1/5 mr-1 font-bold text-red-600"
                        v-if="form.produtos.length > 0"
                      >
                        <div class="w-full mr-1">
                          <label
                            class="block px-3 mb-2 text-lg font-bold text-center text-grey-darker"
                            for="especificacao"
                            >Vl. Total</label
                          >
                          <input
                            class="w-full px-3 py-2 font-bold text-center border rounded appearance-none text-grey-darker"
                            type="text"
          ...
          <span
            class="flex p-4 font-bold text-red-500 rounded-md text-md bg-red-50"
            v-if="
