              ...
              <div class="py-4 px-8">
                <div class="flex">
                  <div class="w-1/4 mr-1">
                    ...
                    <div class="flex-shrink-0 w-full h-30 w-30 pl-10">
                  ...
                  <div class="flex mb-4">
                      <div class="w-1/2 mr-1">
                          <label class="block text-grey-darker text-lg font-bold mb-2"
                          for="peso">Telefone 1</label>
                          <input class="appearance-none border rounded w-full
                          py-2 px-3 text-grey-darker" id="telefone1" type="number"
                          step="any"
                      ...
                      <div class="w-1/2 mr-1">
                          ...
                          <input class="appearance-none border rounded w-full
                          py-2 px-3 text-grey-darker" id="telefone2" type="number"
                          step="any"
                      ...
                      <div class="w-1/2 mr-1">
                          ...
                          <input class="appearance-none border rounded w-full
                          py-2 px-3 text-grey-darker" id="telefone3" type="number"
                          step="any"
                  ...
                  <div class="mb-4">
                      ...
                      <p class="text-red-500 text-lg font-bold mt-2 p-2 bg-red-50" v-for="error, index in form.errors" :key="index" v-if="form.hasErrors" >
                          - {{ error }}
                      </p>
                  </div>
