...
return new class extends Migration
{
    ...
    {
        Schema::create('entrada_auxes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('entrada_id')->constrained('entradas')->nullable()->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('entrada_auxes');
    }
};
